...
Similarly, there are myriads of (often bespoce) financial contracts, 
...
standard for digital financial contract representation, \ldots
ACTUS stands for 
...
ACTUS alone cannot be used. It's an enabler. Such as the standardization of nuts 
of bolts in the 19th century was an enabler.
A box of standardized 
nuts and bolts without knowing where they are needed is also
quite useless. Still, this standardization gave a boost to industrial development. 
...
These are the transaction systems. However, there is another layer that concerns
the analytics of both, for purposes internal to the institution (upper management) 
and external purposes (e.g. regulation). This parts shows serious shortcomings.
Unfortunately, usually these shortcomings are papered over and up to now no
...
transparent and, as a consequence, the financial system more stable.
